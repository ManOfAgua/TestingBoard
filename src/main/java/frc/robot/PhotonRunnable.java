...
public class PhotonRunnable implements Runnable {
  ...
  public PhotonRunnable(String[] cameraNames, Transform3d[] robotToCameras, BiConsumer<Pose2d, Double> poseConsumer,
    ...
    PortForwarder.add(5810, "10.58.52.11", 5800);
    PortForwarder.add(1181, "10.58.52.11", 1181);
    PortForwarder.add(1182, "10.58.52.11", 1182);
    PortForwarder.add(1183, "10.58.52.11", 1183);
    PortForwarder.add(1184, "10.58.52.11", 1184);
    PortForwarder.add(1185, "10.58.52.11", 1185);
    PortForwarder.add(1186, "10.58.52.11", 1186);
    PortForwarder.add(1187, "10.58.52.11", 1187);
    PortForwarder.add(1188, "10.58.52.11", 1188);
